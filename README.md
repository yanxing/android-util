...
[NotchPhoneUtil](https://github.com/yanxing/android-util/blob/master/app/src/main/java/com/yanxing/util/NotchPhoneUtil.java)
## networklibrary
...
```java
 ...
 androidx
 ```java
 compile 'com.yanxing:networklibrary:2.0.1'
 ```
